  ...
  sections: [
    {
      ...
      features: [
        ...
        { title: 'Per-app profiles', desc: 'Override concurrency, rate limits, and presets per application — give your browser one budget and your batch jobs another.' },
        { title: 'Optional auth', desc: 'Start with --require-auth to generate a local token and lock down the daemon API. Simulation endpoints are gated behind --enable-simulation.' },
        { title: '195 tests', desc: 'Config validation, flood simulation, redaction, diagnostics — all deterministic via FakeSystemMetrics dependency injection.' },
      ],
    },
    {
      kind: 'code-cards',
    ...
    },
    {
      ...
      rows: [
        ...
        ['POST', '/preset/apply', 'Apply a preset'],
        ...
        ['GET', '/events/stream', 'Poll for new events'],
      ],
    },
    {
      kind: 'features',
